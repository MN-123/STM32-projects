 ...
 *	
 * 	
 * Also, other pins can be changed as well
 * 
 *	//Default RST pin
...
#define PCD8544_RST_RCC			RCC_AHB1Periph_GPIOA
...
#define PCD8544_DC_PIN			GPIO_Pin_8
#endif
//Default CE pin
...
#define PCD8544HorizontalLine(y) PCD8544_DrawLine(0, y, PCD8544_WIDTH, y, PCD8544_Pixel_Set);
#define PCD8544VerticalLine(x)  PCD8544_DrawLine(x, 0, x, PCD8544_WIDTH, PCD8544_Pixel_Set);


/**
 * Initialize all IO pins and peripheral
 * @note ported to STMF10 by SirVolta
 *
 */
...
/**
 * Shift content of framebuffer x pixels up
 * @note added by SirVolta
 *
 * Parameters
 * - unsigned char x: x position of pixel
 * - uint8_t hight: amount of lines to shift up
 */
void PDC8544ShiftFrameBuffer (uint8_t height);
#endif
